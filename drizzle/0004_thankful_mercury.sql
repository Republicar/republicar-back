...
--> statement-breakpoint
INSERT INTO `__new_expenses`("id", "description", "amount", "date", "republic_id", "created_at") SELECT "id", "description", "amount", "date", "republic_id", "created_at" FROM `expenses`;--> statement-breakpoint
